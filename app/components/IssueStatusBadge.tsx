...
//outside of this component, we want to define mapping between "issues 
//statuses" and their "colors" and "labels".the reason I defined this 
//mapping outside of this component is because we don't need this to run
//every time we want to render a component.
...
//type".In it's angle brackets, we should specify "the type of our keys and 
...
//"random string".we have to set it to a set of predefined values that 
//we used here.(here red, violet and green)
