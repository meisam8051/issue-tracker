...
//4-This is another peice of our detail issue page.

//5-Now here we need to know the issue to render.If this is the only 
...
//compoents" in our "detail issue page".So we use "prop solution" for 
//geting it from our "detail issue page".  
