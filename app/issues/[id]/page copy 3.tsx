...
const IssueDetailPage = async ({ params }: Props) => {
    ...
    //1-Here we use "radix ui" component for styling our "issue detail 
    //page".

    return (
        <div>
            {/* 2-Heading by default is h1 but we can always overwrite
            it with "as prop" to show other headings tag like h2 and so 
            on. 
            */}
            <Heading>{issue.title}</Heading>
            {/* 3-For using flex to show our status and date horizontally
            we can use "a div with class flex" or "flex component" in 
            Radix-UI.
           "gap prop" gives a space between the children of "Flex 
            component".
              */}
            <Flex gap="4" my="2">
